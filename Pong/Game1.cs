...
namespace Pong
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            PaddleTop.Position = new Vector2(0, 580);
            // Load ball texture
    ...
    public class CollisionDetector
    {
        ...
        public static bool Overlaps(Sprite s1, Sprite s2)//s1 je ball, s2 je paddle
        {
            if (s1.Position.X < s2.Size.Height - Bounce || s1.Position.Y + s1.Size.Width > myHeight - s2.Size.Height + Bounce)
            {
                return true;
            }
            if (s1.Position.X + s1.Size.Width >= s2.Position.X && s1.Position.X + s2.Size.Width <= s2.Position.X  && s1.Position.Y <= s2.Size.Height - myHeight)
            {
                return true;
            }
            return false;
